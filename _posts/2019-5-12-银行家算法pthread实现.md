...
银行家算法是操作系统中的一个经典算法，关于这个算法本身可以看教科书《Operation System Concepts（Seventh Edition）》7.5.3小节，或者[wiki](https://en.wikipedia.org/wiki/Banker's_algorithm)。这是我使用C语言pthread库（即Linux线程库）的实现。代码如下
